...
export default function Index() {
  ...
  const premiumInputChange = (value: number) => {
    // setPremiumSafetyScore(Number(value.toFixed(2)));
  ...
  const goToBrowseProfile = () => {
    ...
    setShowSimulator(true);
    setShowTable(true);
    setInitPremiumStatus(false);
    setCurContent('simulator');
    // reset premium page status
    setPremiumData({
      Economy: 0,
      Comfort: 0,
      Turbo: 0,
    ...
    setPremiumSafetyScore(0);
    setOriginalAvgScore(0);
  };
        ...
        <div className={`${styles.wrapper}`}>
          <div className={styles.guide}>
            ...
            <div className={styles.guideSteps}>
              ...
              >
                <img src={!isUploadSuccess ? stepOneActive : stepOne} alt="browser profile" />
              </div>
              <div className={styles.stepImage}>
                <img
                  src={isUploadSuccess && !initChartStatus ? stepTwoActive : stepTwo}
                  alt="browser profile"
                />
              </div>
              <div className={styles.stepImage}>
                <img
                  src={initChartStatus && !initPremiumStatus ? stepThreeActive : stepThree}
                  alt="browser profile"
                />
              </div>
              <div className={`${styles.stepImage} ${styles.imageCanClick}`} onClick={goToPremium}>
                <img src={initPremiumStatus ? stepFourActive : stepFour} alt="browser profile" />
              </div>
            </div>
                        ...
                        <div>
                          ...
                          <div
                            className={`${styles.disCount} ${
                              Number(originalAvgScore.toFixed(2)) >= 0
                                ? styles.greenText
                                : styles.redText
                            }`}
                          >
                  ...
                  <>
                      ...
                      <div className={styles.simulatorContainer}>
                        ...
                        <div className={styles.simulatorCount}>
                          ...
                          <InputNumber
                            min={1}
                            defaultValue={parseFloat(
                              (simulatorData?.vehicle_mileage || 0).toFixed(3),
                            )}
                    ...
                    <div className={styles.disCountWrapper}>
                      {/* <div className={styles.avgScore}>
                        <div>
                          <span className={styles.avgScoreTitle}>
                            {`${lastestDayData?.start_date}    ROLLING AVG SCORE`}:{' '}
                            <span className={styles.avgScoreData}>{avgScore.toFixed(2)}</span>
                          </span>
                        </div>
                      </div> */}
                      <div className={styles.discountContainer}>
